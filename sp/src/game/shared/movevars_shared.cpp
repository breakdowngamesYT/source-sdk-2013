...
ConVar	sv_rollspeed	( "sv_rollspeed", "200", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_CHEAT);
ConVar	sv_rollangle	( "sv_rollangle", "3", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_CHEAT, "Max view roll angle");
#endif // CSTRIKE_DLL
